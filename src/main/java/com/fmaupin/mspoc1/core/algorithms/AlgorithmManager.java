...
public class AlgorithmManager<T, R> {
    ...
    public List<R> execute(AlgorithmEnum feature, List<T> dataInput)
        ...
        if (dataInput.isEmpty()) {
            throw new IllegalArgumentException(
                    String.format("%s: %s", Constants.INCORRECT_VALUE, Constants.DATA_PARAMETER));
        }
     ...
     * @throws AlgorithmNotFoundException
     */
    private Algorithm<T, R> getAlgorithm(AlgorithmEnum feature) throws AlgorithmNotFoundException {
